...
public class HampterBehavior : MonoBehaviour 
{
    public class IsWithinRangeHampter : Node
    {
        Transform target;
        Transform self;
        NavMeshAgent agent;
        ...
        public IsWithinRangeHampter(Transform target, Transform self, float detectionRange) : base()
        {
            this.target = target;
            this.self = self;
    ...
    public class PatrolTaskHampter : Node
    {
        ...
        public PatrolTaskHampter(List<Transform> targets, NavMeshAgent agent, float waitTime, Animator anim)
        {
